...
?></td>
	...
	<tr>
		...
		<?php } else {; ?> <?php echo "Sem informação"; ?> <?php }; ?></td>
...
?></td>
	...
	<tr>
		<td>Local da moradia da famíla do aluno<br>
...
?></td>
	...
	<tr>
		<td>Condições da moradia - aluno reside com a família<br>
...
?></td>
	...
	<tr>
		<td>Moradia alternativa para aluno cuja família reside em outro
		local</td>
		<td><?php
...
?></td>
	...
	<tr>
		<td>Tempo gasto para chegar à UFRJ<br>
...
?></td>
	...
	<tr>
		<td>Número de conduções utilizadas<br>
