...
<h2>Uma vez inseridos os familiares não residentes <?php echo
$html->link("continuar", "/Rendas/add/" . $aluno_id);
?></h2>

<fieldset><legend>Informações sobre familiares (mãe,
pai, cônjuge) que não residam com aluno</legend> <?php echo 
$form->create('Aluno', array('type' => 'file', 'action'=>'enaoresidente'));
?> Vínculo familiar: <?php
...
?> Outro vínculo familiar (especificar): <?php
