...
<fieldset><legend>Despesas da família que podem ser
comprovadas</legend> <?php echo $form->create('Aluno', array('action' => 'edespesa')); ?>
...
?></td>
		...
		<tr>
			<td style="text-align: left">Gâs</td>
			<td><?php
...
?></td>
		...
		<tr>
			<td style="text-align: left">Aluguel / Financiamento</td>
			<td><?php
...
?></td>
		...
		<tr>
			<td style="text-align: left">Condomínio</td>
			<td><?php
...
?></td>
		...
		<tr>
			<td style="text-align: left">Outra: <?php
echo $form->input('despesa_especificar', array('type'=>'text', 'size'=>'15', 'label'=>false));
?></td>
			<td><?php
