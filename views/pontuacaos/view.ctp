...
<?php echo $renda_total; ?>
<br>
Total integrantes da família: <?php echo $total; ?>
</td>
...
<table>
<tr><th>Parentesco</th><th>Profissão</th><th>Remuneração</th></tr>
...
<tr>
<td>
    <?php echo $html->link("Bens", "/Alunos/epropriedade/" . $aluno['Aluno']['id']); ?>
<br />

Propriedade imóvel: 
<?php echo $aluno['Aluno']['propriedade_imovel']; ?><br />

Propriedade residencial alugada: 
<?php echo $aluno['Aluno']['propriedade_residencial_alugada']; ?><br />

Propriedade comercial alugada:
<?php echo $aluno['Aluno']['propriedade_comercial_alugada']; ?>    
<br />

Outra propriedade:
<?php echo $aluno['Aluno']['propriedade_outro']; ?>
<br />

Automóvel:
<?php echo $aluno['Aluno']['propriedade_automovel']; ?>
<br />

Marca:
<?php echo $aluno['Aluno']['propriedade_automovel_marca']; ?>
<br />

Ano:
<?php echo $aluno['Aluno']['propriedade_automovel_ano']; ?>
</td>
<td>
<?php
...
<tr>
<td>
<?php echo $html->link("Despesas com habitação (aluguel ou prestação da casa)", "/Despesas/listar/" . $aluno['Aluno']['id']); ?>
<br />
...
Total despesas: <?php echo $total; ?>
<?php } else {; ?>
<?php echo "Sem informação"; ?>
<?php }; ?>
</td>
...
<tr>
<td>
<?php echo $html->link("Despesas gerais", "/Despesas/view/" . $aluno['Aluno']['id']); ?>
<br />
<?php if ($despesa) {; ?>
<table>
<tr>
...
<tr>
<td>
Condições verificadas a partir da visita domiciliar realizada
</td>
<td>
<?php
...
<tr>
<td>
<?php echo $html->link("Local da moradia da famíla do aluno", "/Alunos/edit/" . $aluno['Aluno']['id']); ?>
<br />
...
Estado família: <?php echo $aluno['Aluno']['familia_estado']; ?>
</td>
<td>
<?php
...
<tr>
<td>
<?php echo $html->link("Condições da moradia - aluno reside com a família", "/Alunos/edit/" . $aluno['Aluno']['id']); ?>
<br />
...
<tr>
<td>
<?php echo $html->link("Moradia alternativa para aluno cuja família reside em outro local", "/Alunos/edit/" . $aluno['Aluno']['id']); ?>
<br />
Com quem reside o aluno: <?php echo $aluno['Aluno']['reside_com']; ?>
</td>
<td>
...
<tr>
<td>
<?php echo $html->link("Tempo gasto para chegar à UFRJ", "/Alunos/etransporte/" . $aluno['Aluno']['id']); ?>
<br />
Tempo para chegar à UFRJ: <?php echo
$aluno['Aluno']['transporte_tempo']; ?>
</td>
<td>
<?php
...
<tr>
<td>
<?php echo $html->link("Número de conduções utilizadas", "/Alunos/etransporte/" . $aluno['Aluno']['id']); ?>
<br />
Conduções utilizadas: <?php echo
$aluno['Aluno']['transporte_quantidade']; ?>
</td>
<td>
<?php
