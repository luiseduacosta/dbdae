...
<fieldset><legend>Rendimento familiar</legend> <?php echo $form->create('Aluno', array('type'=>'file',
'action'=>'familia')); ?> Total de rendimentos familiares: R$ <?php
    echo $form->input("rendimento_familiar", array("type"=>"text", "size"=>"6", 'value'=>$total, "label"=>false));
?> Observações (utilize este espaço para informações adicionais ou
esclarecimentos): <?php
