...
echo $form->input('beneficio', array('type'=>'select', 'value'=>$aluno['Aluno']['beneficio'], 'options'=>$opcoes, 'label'=>false));
...
?> Em que ano: <?php
echo $form->input('beneficio_ano', array("type"=>'text', "size"=>'4', "value"=>$aluno['Aluno']['beneficio_ano'], "label"=>false));
?> Calouro? <?php
echo $form->input('calouro', array('type'=>'select',
'options'=>array('0'=>'Não','1'=>'Sem'), 'size'=>'1', 'label'=>false));
?> Qual semestre: <?php
...
echo $form->input('nome', array('type'=>'text', 'size'=>'70', "value"=>$aluno['Aluno']['nome'], "label"=>false));
?> CPF: <?php
...
?> Naturalidade: <?php
echo $form->input("naturalidade", array("type"=>'text', 'size'=>'20', "label"=>false));
?> Endereço: <?php
...
?> Cidade: <?php
echo $form->input("cidade", array("type"=>'text', 'size'=>'20', "label"=>false));
?> Estado: <?php
echo $form->input("estado", array("type"=>'text', 'size'=>'2', "label"=>false));
?> CEP: <?php
...
?> CEP do endereço da família: <?php
...
<fieldset><legend>Dados sócio-econômicos</legend> Locais onde
faz regularmente as refeições: <?php
...
?> Especificar outros: <?php
echo $form->input("local_refeicao_outro", array("type"=>"text", "size"=>"15", "label"=>false));
?>

<fieldset><legend>Transporte</legend> O aluno utiliza veículo
de sua propriedade ou da família para vir a UFRJ? <?php
...
<?php
echo $form->input("id", array("type"=>"text", "size"=>"2",
"value"=>$aluno_id, "label"=>false));
?> <?php echo $form->end('Enviar'); ?></fieldset>
