...
/*
     var $validate = array(
            'beneficio_ano'=>array('rule'=>'numeric',
                            'required'=>false,
                            'allowEmpty'=>true,
            ...
            'nome'=> array("rule"=>'notEmpty',
                            ...
                            'allowEmpty'=>false,
                            'message'=>'Obrigatório'),
            'curso'=>array('rule'=>'notEmpty',
                            'required'=>true,
                            'allwEmpty'=>false,
                            'message'=>'Obrigatório'),
            'dre'=>array('rule'=>'numeric',
                            'required'=>true,
                            'allowEmpty'=>false,
            ...
            'reside_com'=>array('rule'=>'notEmpty',
                            'required'=>true,
                            'allowEmpty'=>false,
                            'message'=>'Informe com quem reside'),
            'familia_cep'=>array('rule'=>'cep',
                            'required'=>false,
                            'allowEmpty'=>true,
                            'message'=>'Digite o CEP no formato xxxxx-xx'),
            'transporte_quantidade'=>array('rule'=>'numeric',
                            'required'=>false,
                            'allowEmpty'=>true,
                            'message'=>'Digite somente números'),
            'transporte_gasto'=>array('rule'=>array('decimal', 2),
                            'required'=>false,
                            'allowEmpty'=>true,
